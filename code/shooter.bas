...
LOCATE 10, 25: PRINT "Í = 0"
LOCATE 11, 25: PRINT CHR$(1); " = 1"
LOCATE 12, 25: PRINT CHR$(2); " = 2"
LOCATE 13, 25: PRINT CHR$(5); " = 3"
LOCATE 14, 25: PRINT CHR$(6); " = 4"
LOCATE 15, 25: PRINT "Ô = 5"
LOCATE 16, 25: PRINT "Î = 6"
LOCATE 17, 25: PRINT "ù = 7"
LOCATE 18, 25: PRINT "è = 8"
DO
LET A$ = INKEY$
LOOP UNTIL A$ <> ""
...
200
COLOR 14, 0
IF ACR% = 0 THEN LOCATE AUD%, ALR%: PRINT "Í"
...
IF ACR% = 5 THEN LOCATE AUD%, ALR%: PRINT "Ô"
IF ACR% = 6 THEN LOCATE AUD%, ALR%: PRINT "Î"
IF ACR% = 7 THEN LOCATE AUD%, ALR%: PRINT "ù"
IF ACR% = 8 THEN LOCATE AUD%, ALR%: PRINT "è"
RETURN

250
COLOR 2, 0
IF BCR% = 0 THEN LOCATE BUD%, BLR%: PRINT "Í"
...
IF BCR% = 5 THEN LOCATE BUD%, BLR%: PRINT "Ô"
IF BCR% = 6 THEN LOCATE BUD%, BLR%: PRINT "Î"
IF BCR% = 7 THEN LOCATE BUD%, BLR%: PRINT "ù"
IF BCR% = 8 THEN LOCATE BUD%, BLR%: PRINT "è"
RETURN
